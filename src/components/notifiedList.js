...
class NotifiedCustomerInfo extends Component {
        ...
        <div key={index} className="container">
          <div className="row #78909c blue-grey lighten-1">
            <div className="col s12">
              <button
                className="btn-small waves-effect  waves offset-s5 col s3 #ffcc80 orange lighten-3"
              ...
              <button
                className="btn-small waves-effect  waves offset-s1 col s3 #e57373 red lighten-2"
  ...
  render() {
    return (
      <Fragment>
        <div>{this.renderNotifiedListOnDom()}</div>
      </Fragment>
    );
  }
}
